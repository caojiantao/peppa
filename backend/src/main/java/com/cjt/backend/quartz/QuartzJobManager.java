package com.cjt.backend.quartz;
...
public class QuartzJobManager {
   ...
   * 添加定时任务
   */
  public <T extends BaseJob> void addJob(T job) {
  ...
  public <T extends BaseJob> void pauseJob(T job) {
  ...
  public <T extends BaseJob> void resumeJob(T job) {
  ...
  public <T extends BaseJob> void removeJob(T job) {
